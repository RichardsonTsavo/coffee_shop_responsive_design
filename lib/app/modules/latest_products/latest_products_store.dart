...
part 'latest_products_store.g.dart';

class LatestProductsStore = _LatestProductsStoreBase with _$LatestProductsStore;

abstract class _LatestProductsStoreBase with Store {
  LocalizationSystem localizationSystem = Modular.get();
  final IRequestsRepository _getProductsRepository = RequestsRepository();

  Future<List<ProductModel>> getAllLastProducts() {
    return _getProductsRepository.getLastProducts();
  }
